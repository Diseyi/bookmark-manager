        ...
        <Container>
            <div className="flex flex-col items-center py-10 lg:flex-row relative gap-8 md:gap-24 lg:gap-24">
                ...
                <div className="lg:w-1/2 text-center lg:text-left text-dark-blue mt-20 md:mt-0">
                    <h2 className="text-2xl font-bold md:text-3xl">Intelligent search</h2>
                    <p className="font-light md:w-2/3 mx-auto lg:w-full opacity-50 py-4">   Our powerful search feature will help you find saved sites in no time at all.
